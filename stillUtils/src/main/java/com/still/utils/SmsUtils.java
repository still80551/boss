...
public class SmsUtils {
    ...
    static final String accessKeyId = "LTAIPJ0EtiqFcJrQ";
    static final String accessKeySecret = "gS5xqts4h4UmDKtF8NSrHgXfeY7sP1";
    ...
    public static SendSmsResponse sendSms(String telephone, String code)
        ...
        // 必填:短信签名-可在短信控制台中找到
        request.setSignName("罗锦容");
        // 必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_128520170");
